...
% up sample
n1up = 0:L1*N1-1;            % original 11 time series
t1up = n1up*(0.5/fs);        % time series 11
y1up = sin(2*pi*f11*t1up) + sin(2*pi*f21*t1up);  % sin1 up sample
% down sample
...
% up sample
n2up = 0:L2*N2-1;            % original 11 time series
t2up = n2up*(1/L2/fs);       % time series 11
y2up = sin(2*pi*f12*t2up) + sin(2*pi*f22*t2up);  % sin2 up sample
% down sample
